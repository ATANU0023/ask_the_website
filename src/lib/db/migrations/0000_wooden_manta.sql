...
ALTER TABLE "usage_tracking" ADD CONSTRAINT "usage_tracking_document_id_documents_id_fk" FOREIGN KEY ("document_id") REFERENCES "public"."documents"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
CREATE UNIQUE INDEX "verification_tokens_identifier_token_index" ON "verification_tokens" USING btree ("identifier","token");--> statement-breakpoint
